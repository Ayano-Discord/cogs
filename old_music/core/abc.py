...
class MixinMeta(ABC):
    ...
    @abstractmethod
    def decode_track(
        self, track: str, decode_errors: str = ""
    ) -> MutableMapping:
        raise NotImplementedError()
    ...
    @abstractmethod
    async def _eq_check(
        self, ctx: commands.Context, player: lavalink.Player
    ) -> None:
        raise NotImplementedError()
    ...
    async def command_play(
        self, ctx: commands.Context, *, queries: List[Query]
    ):
        raise NotImplementedError()
    ...
    async def _build_queue_search_page(
        ...
        ctx: commands.Context,
        page_num: int,
        search_list: List[Tuple[int, str]],
    ) -> discord.Embed:
        raise NotImplementedError()
