...
class NodeConfigManager(CacheBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._cached_global: Dict[
            Optional[str],
            Union[Dict[str, Union[str, int, bool, None]], Set[str]],
        ] = {}
    ...
    async def get_host(self, node_identifier: str = "primary") -> str:
        ...
        self._cached_global.setdefault(
            node_identifier,
            self._config.defaults["GLOBAL"]["lavalink"]["nodes"]["primary"],
        )
        if self.enable_cache and None in self._cached_global:
            ret = self._cached_global[node_identifier]["host"]
        else:
            ret = await self._config.lavalink.nodes.get_raw(
                node_identifier, "host"
            )
            self._cached_global[node_identifier]["host"] = ret
        return ret

    async def set_host(
        self, set_to: str, node_identifier: str = "primary"
    ) -> None:
        self._cached_global.setdefault(
            node_identifier,
            self._config.defaults["GLOBAL"]["lavalink"]["nodes"]["primary"],
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "host", value=set_to
            )
            self._cached_global[node_identifier]["host"] = set_to
        else:
            await self._config.lavalink.nodes.clear_raw(
                node_identifier, "host"
            )
            self._cached_global[node_identifier][
                "host"
            ] = self._config.defaults["GLOBAL"]["lavalink"]["nodes"][
                "primary"
            ][
                "host"
            ]
    ...
    async def get_port(
        self, node_identifier: str = "primary"
    ) -> Optional[int]:
        ret: int
        self._cached_global.setdefault(
            node_identifier,
    ...
    async def set_port(
        self, set_to: int, node_identifier: str = "primary"
    ) -> None:
        self._cached_global.setdefault(
            node_identifier,
            self._config.defaults["GLOBAL"]["lavalink"]["nodes"]["primary"],
        ...
        await self._config.lavalink.nodes.set_raw(
            node_identifier, "port", value=set_to
        )
    ...
    async def set_rest_uri(
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "rest_uri", value=set_to
            )
    ...
    async def set_password(
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "password", value=set_to
            )
    ...
    async def set_identifier(
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "identifier", value=set_to
            )
            self._cached_global[node_identifier]["identifier"] = set_to
            await self._config.lavalink.nodes.clear_raw(node_identifier)
            self._cached_global[set_to] = self._cached_global.pop(
                node_identifier
            )
            await self._config.lavalink.nodes.set_raw(
                set_to, value=self._cached_global[set_to]
            )
        else:
            await self._config.lavalink.nodes.clear_raw(
                node_identifier, "identifier"
    ...
    async def set_region(
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "region", value=set_to
            )
    ...
    async def set_shard_id(
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "shard_id", value=set_to
            )
    ...
    async def get_search_only(self, node_identifier: str = "primary") -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = await self._config.lavalink.nodes.get_raw(
                node_identifier, "search_only"
            )
            self._cached_global[node_identifier]["search_only"] = ret
        return ret

    async def set_search_only(
        self, set_to: bool, node_identifier: str = "primary"
    ) -> None:
        self._cached_global.setdefault(
            node_identifier,
            self._config.defaults["GLOBAL"]["lavalink"]["nodes"]["primary"],
        ...
        if set_to is not None:
            await self._config.lavalink.nodes.set_raw(
                node_identifier, "search_only", value=set_to
            )
    ...
    async def refresh_all_identifiers(self) -> Set[str]:
        self._cached_global[None] = set(
            (await self._config.lavalink.nodes.all()).keys()
        )
        return self._cached_global[None]
