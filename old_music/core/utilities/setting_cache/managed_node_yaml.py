...
class ManagedNodeYamlManager(CacheBase):
    ...
    async def set_server_address(self, set_to: str) -> None:
        if set_to is not None:
            ...
            self._cached_global["server_address"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["server"]["address"]
    ...
    async def set_server_port(self, set_to: int) -> None:
        if set_to is not None:
            ...
            self._cached_global["server_port"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["server"]["port"]
    ...
    async def get_lavalink_password(self) -> str:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.password()
            )
    ...
    async def set_lavalink_password(self, set_to: str) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.password.set(
                set_to
            )
            self._cached_global["lavalink_password"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.password.clear()
            self._cached_global["lavalink_password"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["password"]
    ...
    async def get_lavalink_ytsearch(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.youtubeSearchEnabled()
            )
    ...
    async def set_lavalink_ytsearch(self, set_to: bool) -> None:
        if set_to is not None:
            ...
            self._cached_global["lavalink_ytsearch"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"][
    ...
    async def set_lavalink_scsearch(self, set_to: bool) -> None:
        if set_to is not None:
            ...
            self._cached_global["lavalink_scsearch"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"][
    ...
    async def get_lavalink_update_intervals(self) -> int:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.playerUpdateInterval()
            )
    ...
    async def set_lavalink_update_intervals(self, set_to: int) -> None:
        if set_to is not None:
            ...
            self._cached_global[
                "lavalink_update_intervals"
            ] = self._config.defaults["GLOBAL"]["lavalink"]["managed_yaml"][
                "lavalink"
            ][
                "server"
            ][
    ...
    async def get_lavalink_buffer(self) -> int:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.bufferDurationMs()
            )
            self._cached_global["lavalink_update_intervals"] = ret
        return ret
    ...
    async def set_lavalink_lavalink_buffer(self, set_to: int) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.bufferDurationMs.set(
                set_to
            )
            self._cached_global["lavalink_update_intervals"] = set_to
        else:
    ...
    async def get_jda_nsa(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.jdanas()
            )
    ...
    async def set_jda_nsa(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.jdanas.set(
                set_to
            )
            self._cached_global["jdanas"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.jdanas.clear()
            self._cached_global["jdanas"] = self._config.defaults["GLOBAL"][
                "lavalink"
            ]["managed_yaml"]["lavalink"]["server"]["jdanas"]
    ...
    async def get_source_http(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.sources.http()
            )
    ...
    async def set_source_http(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.http.set(
                set_to
            )
            self._cached_global["source_http"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.http.clear()
            self._cached_global["source_http"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "http"
            ]
    ...
    async def set_source_local(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.local.set(
                set_to
            )
            self._cached_global["source_local"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.local.clear()
            self._cached_global["source_local"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "local"
            ]
    ...
    async def get_source_bandcamp(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.sources.bandcamp()
            )
    ...
    async def set_source_bandcamp(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.bandcamp.set(
                set_to
            )
            ...
            self._cached_global["source_bandcamp"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "bandcamp"
            ]
    ...
    async def get_source_soundcloud(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.sources.soundcloud()
            )
    ...
    async def set_source_soundcloud(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.soundcloud.set(
                set_to
            )
            ...
            self._cached_global["source_soundcloud"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "soundcloud"
            ]
    ...
    async def get_source_twitch(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.sources.twitch()
            )
    ...
    async def set_source_twitch(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.twitch.set(
                set_to
            )
            self._cached_global["source_twitch"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.twitch.clear()
            self._cached_global["source_twitch"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "twitch"
            ]
    ...
    async def get_source_youtube(self) -> bool:
        ...
        if self.enable_cache and None in self._cached_global:
            ...
            ret = (
                await self._config.lavalink.managed_yaml.lavalink.server.sources.youtube()
            )
    ...
    async def set_source_youtube(self, set_to: bool) -> None:
        if set_to is not None:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.youtube.set(
                set_to
            )
            self._cached_global["source_youtube"] = set_to
        else:
            await self._config.lavalink.managed_yaml.lavalink.server.sources.youtube.clear()
            self._cached_global["source_youtube"] = self._config.defaults[
                "GLOBAL"
            ]["lavalink"]["managed_yaml"]["lavalink"]["server"]["sources"][
                "youtube"
            ]
