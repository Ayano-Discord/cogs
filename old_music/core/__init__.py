...
class Music(
    ...
    def __init__(self, bot: Red):
        ...
        lavalink_yaml["lavalink"]["server"][
            "password"
        ] = default_cog_lavalink_settings["primary"]["password"]
        lavalink_yaml["server"]["address"] = "localhost"
        lavalink_yaml["server"]["port"] = default_cog_lavalink_settings[
            "primary"
        ]["port"]
        ...
        self.config.register_custom(
            "EQUALIZER", name="Default", eq_bands=[], eq_presets={}
        )
