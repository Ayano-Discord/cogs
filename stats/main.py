...
class Stats(commands.Cog):
    ...
    async def botinfo(self, ctx: commands.Context):
        ...
        async with ctx.typing():
            ...
            if not bot_has_stats:
                ...
                async for s in AsyncIter(self.bot.guilds, steps=1000, delay=0):
                    ...
                    async for c in AsyncIter(
                        s.text_channels, steps=1000, delay=0
                    ):
                        if c.is_nsfw():
                    ...
                    async for vc in AsyncIter(
                        s.voice_channels, steps=1000, delay=0
                    ):
                        ...
                        async for vcm in AsyncIter(
                            vc.members, steps=1000, delay=0
                        ):
                            if vcm.is_on_mobile():
                                temp_data[
                                    "user_voice_channel_mobile_count"
                                ].add(vcm.id)
                    ...
                    async for m in AsyncIter(s.members, steps=1000, delay=0):
                        ...
                        async for a in AsyncIter(
                            m.activities, steps=1000, delay=0
                        ):
                ...
                online_stats = {
                    ...
                    "\N{VIDEO GAME}\N{VARIATION SELECTOR-16}": counter[
                        "gaming_users"
                    ],
                ...
                online_stats_web = {
                    ...
                    "\N{LARGE RED CIRCLE}": counter[
                        "web_do_not_disturb_users"
                    ],
                ...
                online_stats_desktop = {
                    ...
                    "\N{LARGE RED CIRCLE}": counter[
                        "desktop_do_not_disturb_users"
                    ],
                    "\N{MEDIUM WHITE CIRCLE}": counter[
                        "desktop_offline_users"
                    ],
                }
                online_stats_bots = {
                ...
                online_stats_web = {
                    ...
                    "\N{LARGE RED CIRCLE}": getattr(
                        self.bot.stats.bot,
                        "Users in Do Not Disturb on Browser",
                        0,
                    ),
                    "\N{MEDIUM WHITE CIRCLE}": getattr(
                ...
                online_stats_mobile = {
                    ...
                    "\N{LARGE RED CIRCLE}": getattr(
                        self.bot.stats.bot,
                        "Users in Do Not Disturb on Mobile",
                        0,
                    ),
                    "\N{MEDIUM WHITE CIRCLE}": getattr(
                ...
                online_stats_desktop = {
                    ...
                    "\N{LARGE RED CIRCLE}": getattr(
                        self.bot.stats.bot,
                        "Users in Do Not Disturb on Desktop",
                        0,
                    ),
                    "\N{MEDIUM WHITE CIRCLE}": getattr(
        ...
        uptime_str = humanize_timedelta(timedelta=delta) or _(
            "Less than one second"
        )
        description = _(
            "Uptime: **{time_quantity}** (since {timestamp} UTC)"
        ).format(time_quantity=uptime_str, timestamp=since)
        data = discord.Embed(
        ...
        if not bot_has_stats:
            ...
            data.add_field(
                ...
                value=_(
                    ...
                    total=bold(
                        humanize_number(
                            getattr(self.bot.stats.guilds, "Total", 0)
                        )
                    ),
                    large=bold(
                        humanize_number(
                            getattr(self.bot.stats.guilds, "Large", 0)
                        )
                    ),
                    chuncked=bold(
                        humanize_number(
                            getattr(self.bot.stats.guilds, "Unchunked", 0)
                        )
                    ),
                    unavaliable=bold(
                        humanize_number(
        ...
        if not bot_has_stats:
            for r, value in sorted(verif_count.items(), reverse=False):
                if value:
                    verif_data += (
                        f"{bold(humanize_number(value))} - {verif.get(r)}\n"
                    )
        else:
        ...
        if not bot_has_stats:
            data.add_field(
                ...
                value=_(
                    ...
                    store=bold(
                        humanize_number(counter["store_text_channel_count"])
                    ),
                    nsfw=bold(
                    ...
                    text=bold(
                        humanize_number(counter["guild_text_channel_count"])
                    ),
                    voice=bold(
                        humanize_number(counter["guild_voice_channel_count"])
                    ),
                    users=bold(
                        humanize_number(counter["user_voice_channel_count"])
                    ),
                    with_me=bold(
                        humanize_number(
                            counter["user_voice_channel_with_me_count"]
            ...
            data.add_field(
                ...
                value=_(
                    ...
                    store=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.bot, "Store Text Channels", 0
                            )
                        )
                    ),
                    nsfw=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.bot, "NSFW Text Channels", 0
                            )
                        )
                    ),
                    news=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.bot, "News Text Channels", 0
                            )
                        )
                    ),
                    users_mobile=bold(
                    ...
                    total=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.guilds, "Server Channels", 0
                            )
                        )
                    ),
                    text=bold(
                    ...
                    with_me=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.guilds,
                                "Users in a VC with me",
                                0,
                            )
                        )
                    ),
                    categories=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.guilds, "Channel Categories", 0
                            )
                        )
                    ),
                    bot_with_me=bold(
        ...
        if not bot_has_stats:
            ...
            data.add_field(
                ...
                value=_(
                    ...
                    total=bold(
                        humanize_number(
                            getattr(self.bot.stats.guilds, "Roles", 0)
                        )
                    ),
                    emoji_count=bold(
                        humanize_number(
                            getattr(self.bot.stats.guilds, "Emojis", 0)
                        )
                    ),
                    animated_emoji=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.guilds, "Animated Emojis", 0
                            )
                        )
                    ),
                    static_emojis=bold(
        ...
        for emoji, value in online_stats_desktop.items():
            member_msg_desktop += (
                f"{emoji} {bold(humanize_number(value))} "
                + ("\n" if count % 2 == 0 else "")
            )
            count += 1
        member_msg_bots = ""
        ...
        if member_msg_desktop:
            data.add_field(
                name=_("Desktop Statuses:"), value=member_msg_desktop
            )
        if member_msg_web:
        ...
        for shard_id, latency in self.bot.latencies:
            shard_latencies += f"Shard {shard_id + 1} - {bold(humanize_number(int(latency*1000)))}ms\n"
            count += 1
        ...
        if audio_cog and not bot_has_stats:
            data.add_field(
                ...
                value=_(
                    ...
                    inactive=bold(
                        humanize_number(counter["inactive_music_players"])
                    ),
                ),
            )
            ...
            data.add_field(
                ...
                value=_(
                    ...
                    active=bold(
                        humanize_number(
                            getattr(
                                self.bot.stats.audio, "Active Music Players", 0
                            )
                        )
                    ),
                    inactive=bold(
