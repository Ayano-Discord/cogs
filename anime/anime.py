...
# Music Imports
from .asyncstuff import asyncexe
...
class Anime(commands.Cog):
    """Fetch anime/manga info from kitsu!"""
    ...
    #         """You can give an ID or a name."""
    #         if not anime.isnumeric():
    #             search1 = search
    #             async with self.session as sess:
    #                 async with sess.get(
    #                     f"https://kitsu.io/api/edge/anime?filter[text]={search}",
    #                     query={
    #                         searchAnimeByTitle(title:"Kimetsu", first:5)
    #                     {
    #                         nodes
    #                         {
    #                         slug
